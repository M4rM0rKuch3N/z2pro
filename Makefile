...
#-----------------------------------------------------------------------------
board_remove_apps := AppCenterIntl LogReport MzSecurity NfcNci
...
override_property += \
    ro.flyme.romer=ACAR \
    ro.product.model_romer=Z2-PRO_Unofficial-ACAR
