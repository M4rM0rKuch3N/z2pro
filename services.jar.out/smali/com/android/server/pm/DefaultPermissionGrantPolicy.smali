...
.method private grantDefaultSystemHandlerPermissions(I)V
    ...
    .prologue
    .line 246
    const-string/jumbo v101, "DefaultPermGrantPolicy"

    new-instance v102, Ljava/lang/StringBuilder;

    invoke-direct/range {v102 .. v102}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v103, "Granting permissions to default platform handlers for user "

    invoke-virtual/range {v102 .. v103}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-virtual/range {v102 .. v102}, Ljava/lang/StringBuilder;->toString()Ljava/lang/String;

    move-result-object v102

    invoke-static/range {v101 .. v102}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I
    ...
    .line 257
    .local v63, "locationPackagesProvider":Landroid/content/pm/PackageManagerInternal$PackagesProvider;
    move-object/from16 v0, p0
    ...
    .line 258
    .local v97, "voiceInteractionPackagesProvider":Landroid/content/pm/PackageManagerInternal$PackagesProvider;
    move-object/from16 v0, p0
    ...
    .line 259
    .local v80, "smsAppPackagesProvider":Landroid/content/pm/PackageManagerInternal$PackagesProvider;
    move-object/from16 v0, p0
    ...
    .line 261
    .local v78, "simCallManagerPackagesProvider":Landroid/content/pm/PackageManagerInternal$PackagesProvider;
    move-object/from16 v0, p0
    ...
    .line 275
    const-string/jumbo v101, "com.android.contacts"
    ...
    .line 277
    const-string/jumbo v101, "com.android.calendar"
    ...
    .line 283
    .local v60, "installerPackage":Landroid/content/pm/PackageParser$Package;
    if-eqz v60, :cond_0
    ...
    .line 291
    .local v93, "verifierPackage":Landroid/content/pm/PackageParser$Package;
    if-eqz v93, :cond_1
    ...
    const-string/jumbo v101, "android.media.action.IMAGE_CAPTURE"
    ...
    .line 323
    .local v66, "mediaStorePackage":Landroid/content/pm/PackageParser$Package;
    if-eqz v66, :cond_4
    ...
    .line 329
    :cond_4
    const-string/jumbo v101, "downloads"
    ...
    const-string/jumbo v101, "android.intent.action.VIEW_DOWNLOADS"
    ...
    .line 345
    :cond_6
    const-string/jumbo v101, "com.android.externalstorage.documents"
    ...
    .line 346
    .local v86, "storagePackage":Landroid/content/pm/PackageParser$Package;
    if-eqz v86, :cond_7
    ...
    const-string/jumbo v101, "android.credentials.INSTALL"
    ...
    const-string/jumbo v101, "android.intent.action.DIAL"
    ...
    aget-object v76, v77, v101

    .line 380
    .local v76, "simCallManagerPackageName":Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .line 381
    .local v75, "simCallManagerPackage":Landroid/content/pm/PackageParser$Package;
    if-eqz v75, :cond_a
    ...
    .end local v60    # "installerPackage":Landroid/content/pm/PackageParser$Package;
    .end local v63    # "locationPackagesProvider":Landroid/content/pm/PackageManagerInternal$PackagesProvider;
    .end local v66    # "mediaStorePackage":Landroid/content/pm/PackageParser$Package;
    .end local v73    # "setupPackage":Landroid/content/pm/PackageParser$Package;
    .end local v75    # "simCallManagerPackage":Landroid/content/pm/PackageParser$Package;
    .end local v76    # "simCallManagerPackageName":Ljava/lang/String;
    .end local v78    # "simCallManagerPackagesProvider":Landroid/content/pm/PackageManagerInternal$PackagesProvider;
    .end local v80    # "smsAppPackagesProvider":Landroid/content/pm/PackageManagerInternal$PackagesProvider;
    .end local v86    # "storagePackage":Landroid/content/pm/PackageParser$Package;
    .end local v87    # "syncAdapterPackagesProvider":Landroid/content/pm/PackageManagerInternal$SyncAdapterPackagesProvider;
    .end local v93    # "verifierPackage":Landroid/content/pm/PackageParser$Package;
    .end local v97    # "voiceInteractionPackagesProvider":Landroid/content/pm/PackageManagerInternal$PackagesProvider;
    :catchall_0
    move-exception v101
    ...
    .restart local v63    # "locationPackagesProvider":Landroid/content/pm/PackageManagerInternal$PackagesProvider;
    .restart local v78    # "simCallManagerPackagesProvider":Landroid/content/pm/PackageManagerInternal$PackagesProvider;
    .restart local v80    # "smsAppPackagesProvider":Landroid/content/pm/PackageManagerInternal$PackagesProvider;
    .restart local v87    # "syncAdapterPackagesProvider":Landroid/content/pm/PackageManagerInternal$SyncAdapterPackagesProvider;
    .restart local v97    # "voiceInteractionPackagesProvider":Landroid/content/pm/PackageManagerInternal$PackagesProvider;
    :cond_b
    const/16 v96, 0x0

    .local v96, "voiceInteractPackageNames":[Ljava/lang/String;
    goto/16 :goto_0

    .line 267
    .end local v96    # "voiceInteractPackageNames":[Ljava/lang/String;
    :cond_c
    const/16 v62, 0x0

    .local v62, "locationPackageNames":[Ljava/lang/String;
    goto/16 :goto_1

    .line 269
    .end local v62    # "locationPackageNames":[Ljava/lang/String;
    :cond_d
    const/16 v79, 0x0

    .local v79, "smsAppPackageNames":[Ljava/lang/String;
    goto/16 :goto_2

    .line 271
    .end local v79    # "smsAppPackageNames":[Ljava/lang/String;
    :cond_e
    const/16 v35, 0x0
    ...
    .local v77, "simCallManagerPackageNames":[Ljava/lang/String;
    goto/16 :goto_4

    .line 275
    .end local v77    # "simCallManagerPackageNames":[Ljava/lang/String;
    :cond_10
    const/16 v29, 0x0
    ...
    .restart local v60    # "installerPackage":Landroid/content/pm/PackageParser$Package;
    .restart local v66    # "mediaStorePackage":Landroid/content/pm/PackageParser$Package;
    .restart local v73    # "setupPackage":Landroid/content/pm/PackageParser$Package;
    .restart local v86    # "storagePackage":Landroid/content/pm/PackageParser$Package;
    .restart local v93    # "verifierPackage":Landroid/content/pm/PackageParser$Package;
    :cond_12
    const/16 v101, 0x0
    ...
    const-string/jumbo v101, "android.intent.action.MAIN"
    ...
    .line 391
    .local v81, "smsIntent":Landroid/content/Intent;
    const-string/jumbo v101, "android.intent.category.APP_MESSAGING"
    ...
    .line 394
    .local v82, "smsPackage":Landroid/content/pm/PackageParser$Package;
    if-eqz v82, :cond_15
    ...
    .line 407
    .end local v81    # "smsIntent":Landroid/content/Intent;
    .end local v82    # "smsPackage":Landroid/content/pm/PackageParser$Package;
    :cond_15
    new-instance v18, Landroid/content/Intent;

    const-string/jumbo v101, "android.provider.Telephony.SMS_CB_RECEIVED"
    ...
    const-string/jumbo v101, "android.provider.Telephony.SMS_CARRIER_PROVISION"
    ...
    const-string/jumbo v101, "android.intent.category.APP_CALENDAR"
    ...
    aget-object v83, v79, v101

    .line 399
    .local v83, "smsPackageName":Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .line 400
    .restart local v82    # "smsPackage":Landroid/content/pm/PackageParser$Package;
    if-eqz v82, :cond_1c
    ...
    .line 455
    .end local v82    # "smsPackage":Landroid/content/pm/PackageParser$Package;
    .end local v83    # "smsPackageName":Ljava/lang/String;
    ...
    const-string/jumbo v101, "android.intent.category.APP_CONTACTS"
    ...
    .line 489
    const-string/jumbo v101, "android.app.action.PROVISION_MANAGED_DEVICE"
    ...
    .line 499
    .local v64, "mapsIntent":Landroid/content/Intent;
    const-string/jumbo v101, "android.intent.category.APP_MAPS"
    ...
    .line 502
    .local v65, "mapsPackage":Landroid/content/pm/PackageParser$Package;
    if-eqz v65, :cond_23
    ...
    const-string/jumbo v101, "android.intent.category.APP_GALLERY"
    ...
    const-string/jumbo v101, "android.intent.category.APP_EMAIL"
    ...
    const-string/jumbo v101, "android.intent.category.APP_BROWSER"
    ...
    aget-object v95, v96, v101

    .line 548
    .local v95, "voiceInteractPackageName":Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .line 550
    .local v94, "voiceInteractPackage":Landroid/content/pm/PackageParser$Package;
    if-eqz v94, :cond_29
    ...
    .line 553
    sget-object v104, Lcom/android/server/pm/DefaultPermissionGrantPolicy;->CONTACTS_PERMISSIONS:Ljava/util/Set;
    ...
    .line 555
    sget-object v104, Lcom/android/server/pm/DefaultPermissionGrantPolicy;->CALENDAR_PERMISSIONS:Ljava/util/Set;
    ...
    .line 557
    sget-object v104, Lcom/android/server/pm/DefaultPermissionGrantPolicy;->MICROPHONE_PERMISSIONS:Ljava/util/Set;
    ...
    .line 559
    sget-object v104, Lcom/android/server/pm/DefaultPermissionGrantPolicy;->PHONE_PERMISSIONS:Ljava/util/Set;
    ...
    .line 561
    sget-object v104, Lcom/android/server/pm/DefaultPermissionGrantPolicy;->SMS_PERMISSIONS:Ljava/util/Set;
    ...
    .line 563
    sget-object v104, Lcom/android/server/pm/DefaultPermissionGrantPolicy;->LOCATION_PERMISSIONS:Ljava/util/Set;
    ...
    .line 569
    .end local v94    # "voiceInteractPackage":Landroid/content/pm/PackageParser$Package;
    .end local v95    # "voiceInteractPackageName":Ljava/lang/String;
    :cond_2a
    new-instance v98, Landroid/content/Intent;

    const-string/jumbo v101, "android.speech.RecognitionService"
    ...
    .line 570
    .local v98, "voiceRecoIntent":Landroid/content/Intent;
    const-string/jumbo v101, "android.intent.category.DEFAULT"
    ...
    .line 573
    .local v99, "voiceRecoPackage":Landroid/content/pm/PackageParser$Package;
    if-eqz v99, :cond_2b
    ...
    .line 582
    .local v61, "locationPackage":Landroid/content/pm/PackageParser$Package;
    if-eqz v61, :cond_2c
    ...
    .line 591
    sget-object v104, Lcom/android/server/pm/DefaultPermissionGrantPolicy;->CAMERA_PERMISSIONS:Ljava/util/Set;
    ...
    .line 592
    sget-object v104, Lcom/android/server/pm/DefaultPermissionGrantPolicy;->SENSORS_PERMISSIONS:Ljava/util/Set;
    ...
    .line 593
    sget-object v104, Lcom/android/server/pm/DefaultPermissionGrantPolicy;->STORAGE_PERMISSIONS:Ljava/util/Set;
    ...
    .line 599
    .end local v61    # "locationPackage":Landroid/content/pm/PackageParser$Package;
    .end local v71    # "packageName":Ljava/lang/String;
    :cond_2d
    new-instance v67, Landroid/content/Intent;

    const-string/jumbo v101, "android.intent.action.VIEW"
    ...
    .line 600
    .local v67, "musicIntent":Landroid/content/Intent;
    const-string/jumbo v101, "android.intent.category.DEFAULT"
    ...
    const-string/jumbo v103, "foo.mp3"
    ...
    invoke-static/range {v101 .. v101}, Landroid/net/Uri;->fromFile(Ljava/io/File;)Landroid/net/Uri;

    move-result-object v101

    .line 602
    const-string/jumbo v103, "audio/mpeg"
    ...
    .line 605
    .local v68, "musicPackage":Landroid/content/pm/PackageParser$Package;
    if-eqz v68, :cond_2e
    ...
    const-string/jumbo v103, "android.hardware.type.watch"
    ...
    .line 614
    .local v58, "homeIntent":Landroid/content/Intent;
    const-string/jumbo v101, "android.intent.category.HOME_MAIN"
    ...
    .line 619
    .local v100, "wearHomePackage":Landroid/content/pm/PackageParser$Package;
    if-eqz v100, :cond_2f
    ...
    const-string/jumbo v101, "com.google.android.clockwork.intent.TWINNING_SETTINGS"
    ...
    .line 632
    .local v90, "twinningIntent":Landroid/content/Intent;
    move-object/from16 v0, p0
    ...
    .line 635
    .local v91, "twinningPackage":Landroid/content/pm/PackageParser$Package;
    if-eqz v91, :cond_30
    ...
    const-string/jumbo v101, "com.android.fitness.TRACK"
    ...
    .line 643
    .local v88, "trackIntent":Landroid/content/Intent;
    move-object/from16 v0, p0
    ...
    .line 645
    .local v89, "trackPackage":Landroid/content/pm/PackageParser$Package;
    if-eqz v89, :cond_31
    ...
    .line 654
    .end local v58    # "homeIntent":Landroid/content/Intent;
    .end local v88    # "trackIntent":Landroid/content/Intent;
    .end local v89    # "trackPackage":Landroid/content/pm/PackageParser$Package;
    .end local v90    # "twinningIntent":Landroid/content/Intent;
    .end local v91    # "twinningPackage":Landroid/content/pm/PackageParser$Package;
    .end local v100    # "wearHomePackage":Landroid/content/pm/PackageParser$Package;
    :cond_31
    const-string/jumbo v101, "com.android.printspooler"
    ...
    .line 655
    .local v72, "printSpoolerPackage":Landroid/content/pm/PackageParser$Package;
    if-eqz v72, :cond_32
    ...
    const-string/jumbo v101, "android.telephony.action.EMERGENCY_ASSISTANCE"
    ...
    .line 672
    .local v69, "nfcTagIntent":Landroid/content/Intent;
    const-string/jumbo v101, "vnd.android.cursor.item/ndef_msg"
    ...
    .line 675
    .local v70, "nfcTagPkg":Landroid/content/pm/PackageParser$Package;
    if-eqz v70, :cond_34
    ...
    const-string/jumbo v101, "android.os.storage.action.MANAGE_STORAGE"
    ...
    .line 683
    .local v84, "storageManagerIntent":Landroid/content/Intent;
    move-object/from16 v0, p0
    ...
    .line 685
    .local v85, "storageManagerPckg":Landroid/content/pm/PackageParser$Package;
    if-eqz v85, :cond_35
    ...
    .line 692
    :cond_35
    const-string/jumbo v101, "org.chromium.chrome"
    ...
    .line 700
    :cond_36
    const-string/jumbo v101, "com.google.android.gsf.login"
    ...
    .line 701
    .local v52, "googleaccountPackage":Landroid/content/pm/PackageParser$Package;
    if-eqz v52, :cond_37
    ...
    .line 708
    :cond_37
    const-string/jumbo v101, "com.google.android.googlequicksearchbox"
    ...
    .line 709
    .local v53, "googleappPackage":Landroid/content/pm/PackageParser$Package;
    if-eqz v53, :cond_38
    ...
    .line 722
    :cond_38
    const-string/jumbo v101, "com.google.android.gms"
    ...
    .line 723
    .local v50, "gmscorePackage":Landroid/content/pm/PackageParser$Package;
    if-eqz v50, :cond_39
    ...
    .line 737
    :cond_39
    const-string/jumbo v101, "com.google.android.gms.persistent"
    ...
    .line 738
    .local v51, "gmscorePackagePersistent":Landroid/content/pm/PackageParser$Package;
    if-eqz v51, :cond_3a
    ...
    .line 753
    :cond_3a
    const-string/jumbo v101, "com.google.android.apps.gcs"
    ...
    .line 754
    .local v49, "gcsPackage":Landroid/content/pm/PackageParser$Package;
    if-eqz v49, :cond_3b
    ...
    .line 761
    :cond_3b
    const-string/jumbo v101, "com.google.android.syncadapters.contacts"
    ...
    .line 762
    .local v56, "googlecontactssyncPackage":Landroid/content/pm/PackageParser$Package;
    if-eqz v56, :cond_3c
    ...
    .line 768
    :cond_3c
    const-string/jumbo v101, "com.google.android.backuptransport"
    ...
    .line 769
    .local v54, "googlebackuptransportPackage":Landroid/content/pm/PackageParser$Package;
    if-eqz v54, :cond_3d
    ...
    .line 775
    :cond_3d
    const-string/jumbo v101, "com.google.android.gsf"
    ...
    .line 776
    .local v57, "gsfcorePackage":Landroid/content/pm/PackageParser$Package;
    if-eqz v57, :cond_3e
    ...
    .line 783
    :cond_3e
    const-string/jumbo v101, "com.google.android.setupwizard"
    ...
    .line 784
    .local v74, "setupwizardPackage":Landroid/content/pm/PackageParser$Package;
    if-eqz v74, :cond_3f
    ...
    .line 793
    :cond_3f
    const-string/jumbo v101, "com.google.android.calendar"
    ...
    .line 794
    .local v55, "googlecalendarPackage":Landroid/content/pm/PackageParser$Package;
    if-eqz v55, :cond_40
    ...
    .line 802
    :cond_40
    const-string/jumbo v101, "com.android.vending"
    ...
    .line 803
    .local v92, "vendingPackage":Landroid/content/pm/PackageParser$Package;
    if-eqz v92, :cond_41
    ...
    .line 813
    :cond_41
    const-string/jumbo v101, "com.google.android.apps.tycho"
    ...
    .line 814
    .local v46, "fiPackage":Landroid/content/pm/PackageParser$Package;
    if-eqz v46, :cond_42
    ...
    .line 824
    :cond_42
    const-string/jumbo v101, "com.android.providers.contacts.ContactsProvider2"
    ...
    .line 825
    .local v23, "conpro2Package":Landroid/content/pm/PackageParser$Package;
    if-eqz v23, :cond_43
    ...
    .end local v23    # "conpro2Package":Landroid/content/pm/PackageParser$Package;
    ...
    .end local v46    # "fiPackage":Landroid/content/pm/PackageParser$Package;
    ...
    .end local v49    # "gcsPackage":Landroid/content/pm/PackageParser$Package;
    .end local v50    # "gmscorePackage":Landroid/content/pm/PackageParser$Package;
    .end local v51    # "gmscorePackagePersistent":Landroid/content/pm/PackageParser$Package;
    .end local v52    # "googleaccountPackage":Landroid/content/pm/PackageParser$Package;
    .end local v53    # "googleappPackage":Landroid/content/pm/PackageParser$Package;
    .end local v54    # "googlebackuptransportPackage":Landroid/content/pm/PackageParser$Package;
    .end local v55    # "googlecalendarPackage":Landroid/content/pm/PackageParser$Package;
    .end local v56    # "googlecontactssyncPackage":Landroid/content/pm/PackageParser$Package;
    .end local v57    # "gsfcorePackage":Landroid/content/pm/PackageParser$Package;
    .end local v59    # "i":I
    .end local v60    # "installerPackage":Landroid/content/pm/PackageParser$Package;
    .end local v64    # "mapsIntent":Landroid/content/Intent;
    .end local v65    # "mapsPackage":Landroid/content/pm/PackageParser$Package;
    .end local v66    # "mediaStorePackage":Landroid/content/pm/PackageParser$Package;
    .end local v67    # "musicIntent":Landroid/content/Intent;
    .end local v68    # "musicPackage":Landroid/content/pm/PackageParser$Package;
    .end local v69    # "nfcTagIntent":Landroid/content/Intent;
    .end local v70    # "nfcTagPkg":Landroid/content/pm/PackageParser$Package;
    .end local v72    # "printSpoolerPackage":Landroid/content/pm/PackageParser$Package;
    .end local v73    # "setupPackage":Landroid/content/pm/PackageParser$Package;
    .end local v74    # "setupwizardPackage":Landroid/content/pm/PackageParser$Package;
    .end local v84    # "storageManagerIntent":Landroid/content/Intent;
    .end local v85    # "storageManagerPckg":Landroid/content/pm/PackageParser$Package;
    .end local v86    # "storagePackage":Landroid/content/pm/PackageParser$Package;
    .end local v92    # "vendingPackage":Landroid/content/pm/PackageParser$Package;
    .end local v93    # "verifierPackage":Landroid/content/pm/PackageParser$Package;
    .end local v98    # "voiceRecoIntent":Landroid/content/Intent;
    .end local v99    # "voiceRecoPackage":Landroid/content/pm/PackageParser$Package;
    :catchall_1
    move-exception v101
